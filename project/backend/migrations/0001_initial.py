# Generated by Django 4.0.1 on 2022-04-13 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_selling_price', models.IntegerField(default=None)),
                ('book_mrp', models.IntegerField(default=None)),
                ('book_description', models.CharField(default=None, max_length=1000)),
                ('book_seller', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='backend.user_details', verbose_name='book_seller_id')),
            ],
            options={
